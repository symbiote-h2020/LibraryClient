...
public class FindAndAccessSensorWithGuestToken {
  ...
  public FindAndAccessSensorWithGuestToken() throws SecurityHandlerException {
  ...
  private Map<String, String> getSecurityRequestHeaders() {
    ...
    try {
      ...
      IAAMClient restClient = ClientFactory.getAAMClient(symbioteCoreUrl);
    ...
    } catch (AAMException | JsonProcessingException | JWTCreationException e) {
